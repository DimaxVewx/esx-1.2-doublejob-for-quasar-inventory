Locales['br'] = {
  ...
  ['gave_item'] = 'voce deu ~r~%sx~s~ ~r~%s~s~ para ~r~%s~s~',
  ['received_item'] = 'voce recebeu ~r~%sx~s~ ~r~%s~s~ de ~r~%s~s~',
  ['gave_weapon'] = 'você deu ~r~%s~s~ para ~r~%s~s~',
  ['gave_weapon_ammo'] = 'você deu ~r~%sx %s~s~ para ~r~%s~s~ de ~r~%s~s~',
  ['gave_weapon_withammo'] = 'você deu ~r~%s~s~ com ~r~%sx %s~s~ para ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ já tem um(a) ~r~%s~s~',
  ['gave_weapon_noweapon'] = 'não tem essa arma ~r~%s~s~',
  ['received_weapon'] = 'você recebeu ~r~%s~s~ de ~r~%s~s~',
  ['received_weapon_ammo'] = 'você recebeu ~r~%sx %s~s~ para a sua(o seu) ~r~%s~s~ de ~r~%s~s~',
  ['received_weapon_withammo'] = 'você recebeu ~r~%s~s~ com ~r~%sx %s~s~ de ~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~ tentou lhe dar uma ~r~%s~s~, mas você já tem um(a)',
  ['received_weapon_noweapon'] = '~r~%s~s~ tentou lhe dar munição para ~r~%s~s~, mas você não tem um(a)',
  ['gave_account_money'] = 'voce deu ~r~$%s~s~ (%s) para ~r~%s~s~',
  ['received_account_money'] = 'voce recebeu ~r~$%s~s~ (%s) de ~r~%s~s~',
  ['amount_invalid'] = 'quantidade inválida',
  ['players_nearby'] = 'nenhum cidadão por perto',
  ['ex_inv_lim'] = 'ação não e possivel, excedendo o limite de estoque para ~r~%s~s~',
  ['imp_invalid_quantity'] = 'ação impossível, quantidade inválida',
  ['imp_invalid_amount'] = 'ação impossível, valor invalido',
  ['threw_standard'] = 'você jogou ~r~%sx~s~ ~r~%s~s~',
  ['threw_account'] = 'você jogou ~r~$%s~s~ ~r~%s~s~',
  ['threw_weapon'] = 'você jogou ~r~%s~s~',
  ['threw_weapon_ammo'] = 'você jogou ~r~%s~s~ com ~r~%sx %s~s~',
  ['threw_weapon_already'] = 'você já esta com essa arma',
  ['threw_cannot_pickup'] = 'você não pode pegar porque seu inventário está cheio!',
  ['threw_pickup_prompt'] = 'pressione ~r~E~s~ para pegar',

  -- Key mapping
  ['keymap_showinventory'] = 'exibir inventario',

  -- Salary related
  ['received_salary'] = 'voce recebeu seu salário: ~r~$%s~s~ ',
  ['received_help'] = 'voce recebeu seu cheque de bem-estar: ~r~$%s~s~ ',
