Locales['sc'] = {
  ...
  ['amountammo'] = '弹药量',
  ['noammo'] = '你没有足够的弹药！',
  ['gave_item'] = '你把~r~%sx~s~~r~%s~s~赠给了~r~%s~s~',
  ['received_item'] = '你收到~r~%sx~s~~r~%s~s~，来自~r~%s~s~',
  ['gave_weapon'] = '你把~r~%s~s~赠给了~r~%s~s~',
  ['gave_weapon_ammo'] = '你把~r~%sx~s~~r~%s~s~ %s~s~赠给了~r~%s~s~',
  ['gave_weapon_withammo'] = '你把~r~%s~s~和~r~%sx~s~ %s~s~赠给了~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~已经拥有~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~没有那个武器',
  ['received_weapon'] = '你收到了~r~%s~s~，来自~r~%s~s~',
  ['received_weapon_ammo'] = '你收到了~r~%sx~s~ %s~s~(~r~%s~s~)，来自~r~%s~s~',
  ['received_weapon_withammo'] = '你收到了~r~%s~s~和~r~%sx~s~ %s~s~，来自~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~试图给你~r~%s~s~，但你已经拥有了',
  ['received_weapon_noweapon'] = '~r~%s~s~试图给你~r~%s~s~弹药，但你没有那个武器',
  ['gave_account_money'] = '你将 ~r~$%s~s~ (%s) 给予 ~r~%s~s~',
  ['received_account_money'] = '你收到了~r~$%s~s~ (%s) 来自 ~r~%s~s~',
  ['amount_invalid'] = '无效数量',
  ['players_nearby'] = '附近没有玩家',
  ['ex_inv_lim'] = '操作失败, 超过~r~%s~s~的物品栏限制',
  ['imp_invalid_quantity'] = '操作失败，无效数量',
  ['imp_invalid_amount'] = '操作失败，无效金额',
  ['threw_standard'] = '你丢弃了~r~%sx~s~~r~%s~s~',
  ['threw_account'] = '你丢弃了~r~$%s~s~~r~%s~s~',
  ['threw_weapon'] = '你丢弃了~r~%s~s~',
  ['threw_weapon_ammo'] = '你丢弃了~r~%s~s~和~r~%sx%s~s~',
  ['threw_weapon_already'] = '你已经有同样的武器了',
  ['threw_cannot_pickup'] = '你不能再拿起那个了，因为你的库存已经满了',
  ['threw_pickup_prompt'] = '按 ~r~E~s~ 拿起',

  -- Key mapping
  ['keymap_showinventory'] = '显示库存',

  -- Salary related
  ['received_salary'] = '你收到了你的工资: ~r~$%s~s~',
  ['received_help'] = '你领取到了你的失业救济金: ~r~$%s~s~',
