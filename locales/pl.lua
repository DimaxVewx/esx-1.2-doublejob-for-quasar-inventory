Locales['pl'] = {
  ...
  ['gave_item'] = 'dałeś/aś ~r~%sx~s~ ~r~%s~s~ dla ~r~%s~s~',
  ['received_item'] = 'otrzymałeś/aś ~r~%sx~s~ ~r~%s~s~ od ~r~%s~s~',
  ['gave_weapon'] = 'dałeś/aś ~r~%s~s~ dla ~r~%s~s~',
  ['gave_weapon_ammo'] = 'dałeś/aś ~r~%sx %s~s~ do ~r~%s~s~ dla ~r~%s~s~',
  ['gave_weapon_withammo'] = 'dałeś/aś ~r~%s~s~ z ~r~%sx %s~s~ dla ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ już posiada ~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~ nie posiada tej broni',
  ['received_weapon'] = 'otrzymałeś/aś ~r~%s~s~ od ~r~%s~s~',
  ['received_weapon_ammo'] = 'otrzymałeś/aś ~r~%sx %s~s~ do twojego ~r~%s~s~ od ~r~%s~s~',
  ['received_weapon_withammo'] = 'otrzymałeś/aś ~r~%s~s~ z ~r~%sx %s~s~ od ~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~ próbował/a przekazać ci ~r~%s~s~, lecz już posiadasz jedno',
  ['received_weapon_noweapon'] = '~r~%s~s~ próbował/a przekazać ci amunicje do ~r~%s~s~, lecz nie posiadasz tej broni',
  ['gave_account_money'] = 'dałeś/aś ~r~%s$~s~ (%s) dla ~r~%s~s~',
  ['received_account_money'] = 'otrzymałeś/aś ~r~%s$~s~ (%s) od ~r~%s~s~',
  ['amount_invalid'] = 'nieprawidłowa ilość',
  ['players_nearby'] = 'brak graczy w pobliżu',
  ['ex_inv_lim'] = 'akcja nie jest możliwa, nie możesz mieć więcej ~r~%s~s~',
  ...
  ['threw_standard'] = 'wyrzuciłeś/aś ~r~%sx~s~ ~r~%s~s~',
  ['threw_account'] = 'wyrzuciłeś/aś ~r~$%s~s~ ~r~%s~s~',
  ['threw_weapon'] = 'wyrzuciłeś/aś ~r~%s~s~',
  ['threw_weapon_ammo'] = 'wyrzuciłeś/aś ~r~%s~s~ z ~r~%sx %s~s~',
  ['threw_weapon_already'] = 'już posiadasz taką samą broń',
  ['threw_cannot_pickup'] = 'nie możesz tego podnieść, gdyż masz pełny ekwipunek!',
  ['threw_pickup_prompt'] = 'naciśnij ~r~E~s~ aby podnieść',

  -- Key mapping
  ['keymap_showinventory'] = 'pokaż ekwipunek',

  -- Salary related
  ['received_salary'] = 'otrzymałeś/aś wynagrodzenie: ~r~%s$~s~',
  ['received_help'] = 'otrzymałeś/aś zapomogę: ~r~$%s~s~',
