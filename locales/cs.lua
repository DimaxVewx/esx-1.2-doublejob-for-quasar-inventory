Locales['cs'] = {
  ...
  ['gave_item'] = 'dali jste ~r~%sx~s~ ~r~%s~s~ ~r~%s~s~',
  ['received_item'] = 'obdrželi jste ~r~%sx~s~ ~r~%s~s~ od ~r~%s~s~',
  ['gave_weapon'] = 'dal jsi ~r~%s~s~ hráči ~r~%s~s~',
  ['gave_weapon_ammo'] = 'dal jsi ~r~%sx %s~s~ za ~r~%s~s~ to ~r~%s~s~',
  ['gave_weapon_withammo'] = 'dal jwi ~r~%s~s~ s ~r~%sx %s~s~ to ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ již má ~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~ nemá tuhle zbraň',
  ['received_weapon'] = 'obdrzel jsi ~r~%s~s~ od ~r~%s~s~',
  ['received_weapon_ammo'] = 'obdrzel jsi ~r~%sx %s~s~ za tvůj ~r~%s~s~ od ~r~%s~s~',
  ['received_weapon_withammo'] = 'obdzel jsi ~r~%s~s~ s ~r~%sx %s~s~ od ~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~ se pokusil ti dat ~r~%s~s~, ale jiz tento predmet jednou mas',
  ['received_weapon_noweapon'] = '~r~%s~s~ se pokusil ti dat naboje pro ~r~%s~s~, ale tuhle zbran nemas',
  ['gave_account_money'] = 'dali jste ~r~$%s~s~ (%s) ~r~%s~s~',
  ['received_account_money'] = 'obdrželi jste ~r~$%s~s~ (%s) od ~r~%s~s~',
  ['amount_invalid'] = 'neplatné množství',
  ['players_nearby'] = 'žádní hráči poblíž',
  ['ex_inv_lim'] = 'akce není možná, překročen limit inventáře pro ~r~%s~s~',
  ['imp_invalid_quantity'] = 'akce není možná, neplatný počet',
  ['imp_invalid_amount'] = 'akce není možná, neplatné množství',
  ['threw_standard'] = 'vyhodil jsi ~r~%sx~s~ ~r~%s~s~',
  ['threw_account'] = 'vyhodil jsi ~r~$%s~s~ ~r~%s~s~',
  ['threw_weapon'] = 'vzhodil jsi ~r~%s~s~',
  ['threw_weapon_ammo'] = 'vyhodil jsi ~r~%s~s~ s ~r~%sx %s~s~',
  ['threw_weapon_already'] = 'jiz stejnou zbraan mas',
  ['threw_cannot_pickup'] = 'tohle nemuzes sebrat, protoze tvuj inventar je plny',
  ['threw_pickup_prompt'] = 'stiskni ~r~E~s~ po zvednuti',

  -- Key mapping
  ['keymap_showinventory'] = 'zobrazit inventar',

  -- Salary related
  ['received_salary'] = 'obdrželi jste výplatu: ~r~$%s~s~',
  ['received_help'] = 'obdrželi jste sociální dávku: ~r~$%s~s~',
