Locales['fr'] = {
  ...
  ['gave_item'] = 'vous avez donné ~r~%sx~s~ ~r~%s~s~ à ~r~%s~s~',
  ['received_item'] = 'vous avez reçu ~r~%sx~s~ ~r~%s~s~ par ~r~%s~s~',
  ['gave_weapon'] = 'vous avez donné ~r~1x~s~ ~r~%s~s~ à ~r~%s~s~',
  ['gave_weapon_ammo'] = 'vous avez donné ~r~%sx %s~s~ pour ~r~%s~s~ à ~r~%s~s~',
  ['gave_weapon_withammo'] = 'vous avez donné ~r~1x~s~ ~r~%s~s~ avec ~r~%sx %s~s~ à ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ a déjà ~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~ n\'a pas cette arme',
  ['received_weapon'] = 'vous recevez ~r~1x~s~ ~r~%s~s~ de ~r~%s~s~',
  ['received_weapon_ammo'] = 'vous avez reçu ~r~%sx %s~s~ pour votre ~r~%s~s~ de ~r~%s~s~',
  ['received_weapon_withammo'] = 'vous avez reçu ~r~1x~s~ ~r~%s~s~ avec ~r~%sx %s~s~ de ~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~ a tenté de vous donner ~r~%s~s~, mais vous en aviez déjà un exemplaire',
  ['received_weapon_noweapon'] = '~r~%s~s~ tente de vous donner des munitions pour ~r~%s~s~, mais vous n\'en avez pas',
  ['gave_account_money'] = 'vous avez donné ~r~$%s~s~ (%s) à ~r~%s~s~',
  ['received_account_money'] = 'vous avez reçu ~r~$%s~s~ (%s) par ~r~%s~s~',
  ['amount_invalid'] = 'montant invalide',
  ['players_nearby'] = 'aucun joueur à proximité',
  ['ex_inv_lim'] = 'action impossible, depassement de la limite d\'inventaire pour ~r~%s~s~',
  ['imp_invalid_quantity'] = 'action impossible, ~r~quantité invalide',
  ['imp_invalid_amount'] = 'action impossible, ~r~montant invalide',
  ['threw_standard'] = 'vous avez jreceived_salaryeté ~r~%sx~s~ ~r~%s~s~',
  ['threw_account'] = 'vous avez jeté ~r~$%s~s~ ~r~%s~s~',
  ['threw_weapon'] = 'vous avez jeté ~r~1x~s~ ~r~%s~s~',
  ['threw_weapon_ammo'] = 'vous avez jeté ~r~1x~s~ ~r~%s~s~ avec ~r~%sx %s~s~',
  ...
  ['threw_pickup_prompt'] = 'appuyez sur ~r~E~s~ pour ramasser',

  -- Key mapping
  ['keymap_showinventory'] = 'montrer l\'inventaire',

  -- Salary related
  ['received_salary'] = 'vous avez reçu votre salaire: ~r~$%s~s~',
  ['received_help'] = 'vous avez reçu une aide de l\'état: ~r~$%s~s~',
