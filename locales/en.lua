Locales['en'] = {
  ...
  ['gave_item'] = 'you gave ~r~%sx~s~ ~r~%s~s~ to ~r~%s~s~',
  ['received_item'] = 'you received ~r~%sx~s~ ~r~%s~s~ from ~r~%s~s~',
  ['gave_weapon'] = 'you gave ~r~%s~s~ to ~r~%s~s~',
  ['gave_weapon_ammo'] = 'you gave ~r~%sx %s~s~ for ~r~%s~s~ to ~r~%s~s~',
  ['gave_weapon_withammo'] = 'you gave ~r~%s~s~ with ~r~%sx %s~s~ to ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ already has a ~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~ does not have that weapon',
  ['received_weapon'] = 'you received ~r~%s~s~ from ~r~%s~s~',
  ['received_weapon_ammo'] = 'you received ~r~%sx %s~s~ for your ~r~%s~s~ from ~r~%s~s~',
  ['received_weapon_withammo'] = 'you received ~r~%s~s~ with ~r~%sx %s~s~ from ~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~ attempted to give you a ~r~%s~s~, but you already have one',
  ['received_weapon_noweapon'] = '~r~%s~s~ attempted to give you ammo for a ~r~%s~s~, but you dont have one',
  ['gave_account_money'] = 'you gave ~r~$%s~s~ (%s) to ~r~%s~s~',
  ['received_account_money'] = 'you received ~r~$%s~s~ (%s) from ~r~%s~s~',
  ['amount_invalid'] = 'invalid amount',
  ['players_nearby'] = 'no players nearby',
  ['ex_inv_lim'] = 'action not possible, exceeding inventory limit for ~r~%s~s~',
  ...
  ['threw_weapon'] = 'you threw ~r~%s~s~',
  ['threw_weapon_ammo'] = 'you threw ~r~%s~s~ with ~r~%sx %s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'you received your salary: ~r~$%s~s~',
  ['received_help'] = 'you received your welfare check: ~r~$%s~s~',
