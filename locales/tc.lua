Locales['tc'] = {
  ...
  ['amountammo'] = '子彈量',
  ['noammo'] = '您沒有足夠的子彈！',
  ['gave_item'] = '您把~r~%sx~s~~r~%s~s~給予了~r~%s~s~',
  ['received_item'] = '您收到~r~%sx~s~~r~%s~s~，來自~r~%s~s~',
  ['gave_weapon'] = '您把~r~%s~s~給予了~r~%s~s~',
  ['gave_weapon_ammo'] = '您把~r~%sx~s~~r~%s~s~ %s~s~給予了~r~%s~s~',
  ['gave_weapon_withammo'] = '您把~r~%s~s~和~r~%sx~s~ %s~s~給予了~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~已經有~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~沒有那把武器',
  ['received_weapon'] = '您收到了~r~%s~s~，來自~r~%s~s~',
  ['received_weapon_ammo'] = '您收到了~r~%sx~s~ %s~s~(~r~%s~s~)，來自~r~%s~s~',
  ['received_weapon_withammo'] = '您收到了~r~%s~s~和~r~%sx~s~ %s~s~，來自~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~嘗試给您~r~%s~s~，但您已经有了',
  ['received_weapon_noweapon'] = '~r~%s~s~嘗試给您~r~%s~s~子彈，但是您沒有那把武器',
  ['gave_account_money'] = '您將 ~r~$%s~s~ (%s) 给予 ~r~%s~s~',
  ['received_account_money'] = '您收到了~r~$%s~s~ (%s) 来自 ~r~%s~s~',
  ['amount_invalid'] = '無效的數量',
  ['players_nearby'] = '附近沒有玩家',
  ['ex_inv_lim'] = '操作失敗, 超過~r~%s~s~物品欄位的限制',
  ['imp_invalid_quantity'] = '操作失敗，無效的數量',
  ['imp_invalid_amount'] = '操作失敗，無效的金額',
  ['threw_standard'] = '您丟棄了~r~%sx~s~~r~%s~s~',
  ['threw_account'] = '您丟棄了~r~$%s~s~~r~%s~s~',
  ['threw_weapon'] = '您丟棄了~r~%s~s~',
  ['threw_weapon_ammo'] = '您丟棄了~r~%s~s~和~r~%sx%s~s~',
  ['threw_weapon_already'] = '您已經有相同的武器了',
  ['threw_cannot_pickup'] = '您不能再撿起該物品，因為您的背包已經滿了',
  ['threw_pickup_prompt'] = '按下 ~r~E~s~ 撿起',

  -- Key mapping
  ['keymap_showinventory'] = '顯示背包',

  -- Salary related
  ['received_salary'] = '您收到您的薪水: ~r~$%s~s~',
  ['received_help'] = '你領取到了你的失業救濟金: ~r~$%s~s~',
