Locales['sv'] = {
  ...
  ['gave_item'] = 'du gav ~r~%sx~s~ ~r~%s~s~ till ~r~%s~s~',
  ['received_item'] = 'du tog emot ~r~%sx~s~ ~r~%s~s~ från ~r~%s~s~',
  ['gave_weapon'] = 'du gav ~r~%s~s~ till ~r~%s~s~',
  ['gave_weapon_ammo'] = 'du gav ~r~%sx %s~s~ för ~r~%s~s~ till ~r~%s~s~',
  ['gave_weapon_withammo'] = 'du gav ~r~%s~s~ med ~r~%sx %s~s~ till ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ har redan en ~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~ har inte det vapnet',
  ['received_weapon'] = 'du tog emot ~r~%s~s~ från ~r~%s~s~',
  ['received_weapon_ammo'] = 'du tog emot ~r~%sx %s~s~ för ~r~%s~s~ från ~r~%s~s~',
  ['received_weapon_withammo'] = 'du tog emot ~r~%s~s~ med ~r~%sx %s~s~ från ~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~ försökte ge dig en ~r~%s~s~, men det vapnet har du redan',
  ['received_weapon_noweapon'] = '~r~%s~s~ försökte ge dig ammunition för ett ~r~%s~s~, men du har inget sådant vapen',
  ['gave_account_money'] = 'du gav ~r~%s SEK~s~ (%s) till ~r~%s~s~',
  ['received_account_money'] = 'du tog emot ~r~%s SEK~s~ (%s) från ~r~%s~s~',
  ['amount_invalid'] = 'ogiltig mängd',
  ['players_nearby'] = 'det finns inga spelare nära',
  ['ex_inv_lim'] = 'åtgärd inte möjligt, översteg förråd gräns för ~r~%s~s~',
  ['imp_invalid_quantity'] = 'åtgärd omöjlig, ogiltig mängd',
  ['imp_invalid_amount'] = 'åtgärd omöjlig, ogiltig belopp',
  ['threw_standard'] = 'du kastade ~r~%sx~s~ ~r~%s~s~',
  ['threw_account'] = 'du kastade ~r~%s SEK~s~ ~r~%s~s~',
  ['threw_weapon'] = 'du kastade ~r~%s~s~',
  ['threw_weapon_ammo'] = 'du kastade ~r~%s~s~ med ~r~%sx %s~s~',
  ...
  ['threw_pickup_prompt'] = 'tryck ~r~E~s~ för att plocka upp',

  -- Key mapping
  ['keymap_showinventory'] = 'öppna inventory',

  -- Salary related
  ['received_salary'] = 'du har mottagit din lön på ~r~%s SEK~s~',
  ['received_help'] = 'du har mottagit bidrag på ~r~%s SEK~s~',
