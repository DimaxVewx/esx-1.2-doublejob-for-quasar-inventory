Locales['fi'] = {
  ...
  ['gave_item'] = 'sinä annoit ~r~%sx~s~ ~r~%s~s~ henkilölle ~r~%s~s~',
  ['received_item'] = 'sinä sait ~r~%sx~s~ ~r~%s~s~ henkilöltä ~r~%s~s~',
  ['gave_weapon'] = 'you gave ~r~1x~s~ ~r~%s~s~ to ~r~%s~s~',
  ['gave_weapon_ammo'] = 'you gave ~r~%sx %s~s~ for ~r~%s~s~ to ~r~%s~s~',
  ['gave_weapon_withammo'] = 'you gave ~r~1x~s~ ~r~%s~s~ with ~r~%sx %s~s~ to ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ already have an ~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~ does not have that weapon',
  ['received_weapon'] = 'you received ~r~1x~s~ ~r~%s~s~ from ~r~%s~s~',
  ['received_weapon_ammo'] = 'you received ~r~%sx %s~s~ for your ~r~%s~s~ from ~r~%s~s~',
  ['received_weapon_withammo'] = 'you received ~r~1x~s~ ~r~%s~s~ with ~r~%sx %s~s~ from ~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~ attempted to give you an ~r~%s~s~, but you already have one',
  ['received_weapon_noweapon'] = '~r~%s~s~ attempted to give you ammo for an ~r~%s~s~, but you dont have one',
  ['gave_account_money'] = 'sinä annoit ~r~$%s~s~ (%s) henkilölle ~r~%s~s~',
  ['received_account_money'] = 'sinä sait ~r~$%s~s~ (%s) henkilöltä ~r~%s~s~',
  ['amount_invalid'] = 'virheellinen määrä',
  ['players_nearby'] = 'ei pelaajia lähettyvillä',
  ['ex_inv_lim'] = 'toiminto mahdoton, reppu alkaa olla täysi ~r~%s~s~',
  ['imp_invalid_quantity'] = 'toiminto mahdoton, virheellinen määrä',
  ['imp_invalid_amount'] = 'toiminto mahdoton, virhellinen summa',
  ['threw_standard'] = 'you threw ~r~%sx~s~ ~r~%s~s~',
  ['threw_account'] = 'you threw ~r~$%s~s~ ~r~%s~s~',
  ['threw_weapon'] = 'you threw ~r~1x~s~ ~r~%s~s~',
  ['threw_weapon_ammo'] = 'you threw ~r~1x~s~ ~r~%s~s~ with ~r~%sx %s~s~',
  ...
  ['threw_pickup_prompt'] = 'press ~r~E~s~ to pickup',

  -- Key mapping
  ['keymap_showinventory'] = 'show Inventory',

  -- Salary related
  ['received_salary'] = 'sinä vastaanotit palkkaa: ~r~$%s~s~',
  ['received_help'] = 'sinä vastaanotit valtion tukea: ~r~$%s~s~',
