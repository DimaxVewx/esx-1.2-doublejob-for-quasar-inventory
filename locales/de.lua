Locales['de'] = {
  ...
  ['gave_item'] = 'du gibst ~r~%sx~s~ ~r~%s~s~ an ~r~%s~s~',
  ['received_item'] = 'du empfängst ~r~%sx~s~ ~r~%s~s~ von ~r~%s~s~',
  ['gave_weapon'] = 'du gibst ~r~%s~s~ an ~r~%s~s~',
  ['gave_weapon_ammo'] = 'du gibst ~r~%sx %s~s~ von ~r~%s~s~ an ~r~%s~s~',
  ['gave_weapon_withammo'] = 'du gibst ~r~%s~s~ mit ~r~%sx %s~s~ an ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ hat bereits eine(n) ~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~ hat diese Waffe nicht',
  ['received_weapon'] = 'du erhälst ~r~%s~s~ von ~r~%s~s~',
  ['received_weapon_ammo'] = 'du erhälst ~r~%sx %s~s~ für dein ~r~%s~s~ von ~r~%s~s~',
  ['received_weapon_withammo'] = 'du erhälst ~r~%s~s~ mit ~r~%sx %s~s~ von ~r~%s~s~',
  ['received_weapon_hasalready'] = '~r~%s~s~ hat versucht dir eine(n) ~r~%s~s~ zu geben, aber du hast bereits eine(n)',
  ['received_weapon_noweapon'] = '~r~%s~s~ ahat versucht dir Munition für eine(n) ~r~%s~s~, aber du besitzt diese Waffe nicht',
  ['gave_account_money'] = 'du gibst ~r~$%s~s~ (%s) an ~r~%s~s~',
  ['received_account_money'] = 'du empfängst ~r~$%s~s~ (%s) von ~r~%s~s~',
  ['amount_invalid'] = 'ungültiger Betrag',
  ['players_nearby'] = 'keine Spieler in der Nähe',
  ['ex_inv_lim'] = 'aktion nicht möglich, Inventarlimit überschritten für ~r~%s~s~',
  ...
  ['threw_account'] = 'du wirfst ~r~$%s~s~ ~r~%s~s~ weg',
  ['threw_weapon'] = 'du wirfst ~r~%s~s~ weg',
  ['threw_weapon_ammo'] = 'du wirfst ~r~%s~s~ mit ~r~%sx %s~s~ weg',
  ...
  ['threw_pickup_prompt'] = 'drücke ~r~E~s~ um aufzuheben',

  -- Key mapping
  ['keymap_showinventory'] = 'inventar anzeigen',

  -- Salary related
  ['received_salary'] = 'du hast dein Gehalt erhalten: ~r~$%s~s~',
  ['received_help'] = 'du hast deine Sozialhilfe erhalten: ~r~$%s~s~',
